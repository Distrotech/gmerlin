...
const gavl_stream_header_t * bg_plug_next_packet_header(bg_plug_t * p);

int bg_plug_get_stream_source(bg_plug_t * p, const gavl_stream_header_t *,
                              gavl_audio_source_t ** as,
                              gavl_video_source_t ** vs,
                              gavl_packet_source_t ** ps);


int bg_plug_get_stream_sink(bg_plug_t * p, const gavl_stream_header_t *,
