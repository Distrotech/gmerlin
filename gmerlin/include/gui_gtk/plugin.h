...
typedef struct bg_gtk_encoder_widget_s bg_gtk_encoder_widget_t;
...
void bg_gtk_encoder_widget_set_from_registry(bg_gtk_encoder_widget_t * w, bg_plugin_registry_t * plugin_reg);
void bg_gtk_encoder_widget_set_from_tracks(bg_gtk_encoder_widget_t * w, bg_transcoder_track_t * tracks);
