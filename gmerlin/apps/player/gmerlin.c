...
static bg_accelerator_t accels[] =
  {
    ...
    { BG_KEY_1,       0,                                       ACCEL_SEEK_10                 },
    { BG_KEY_2,       0,                                       ACCEL_SEEK_20                 },
    { BG_KEY_3,       0,                                       ACCEL_SEEK_30                 },
    { BG_KEY_4,       0,                                       ACCEL_SEEK_40                 },
    { BG_KEY_5,       0,                                       ACCEL_SEEK_50                 },
    { BG_KEY_6,       0,                                       ACCEL_SEEK_60                 },
    { BG_KEY_7,       0,                                       ACCEL_SEEK_70                 },
    { BG_KEY_8,       0,                                       ACCEL_SEEK_80                 },
    { BG_KEY_9,       0,                                       ACCEL_SEEK_90                 },
...
void gmerlin_set_parameter(void * data, const char * name,
  ...
  if(!strcmp(name, "skip_error_tracks"))
    ...
    {
    g->skin_dir = gavl_strrep(g->skin_dir, val->val_str);
...
int gmerlin_get_parameter(void * data, const char * name, bg_parameter_value_t * val)
  ...
  if(!strcmp(name, "show_tree_window"))
    ...
    {
    val->val_str = gavl_strrep(val->val_str, g->skin_dir);
    }
