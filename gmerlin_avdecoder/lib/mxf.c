...
static const codec_entry_t mxf_video_codec_uls[] =
  {
    ...
    /* SMPTE D-10 (MPEG-2) */
    { { 0x06,0x0E,0x2B,0x34,0x04,0x01,0x01,0x01,0x04,0x01,0x02,0x02,0x01,0x02,0x01,0x01 }, BGAV_MK_FOURCC('m', 'p', 'g', 'v'), WRAP_FRAME }, /* D-10 50Mbps PAL */
    { { 0x06,0x0E,0x2B,0x34,0x04,0x01,0x01,0x01,0x04,0x01,0x02,0x02,0x01,0x02,0x01,0x02 }, BGAV_MK_FOURCC('m', 'p', 'g', 'v'), WRAP_FRAME }, /* D-10 50Mbps PAL */
    { { 0x06,0x0E,0x2B,0x34,0x04,0x01,0x01,0x01,0x04,0x01,0x02,0x02,0x01,0x02,0x01,0x03 }, BGAV_MK_FOURCC('m', 'p', 'g', 'v'), WRAP_FRAME }, /* D-10 50Mbps PAL */
    { { 0x06,0x0E,0x2B,0x34,0x04,0x01,0x01,0x01,0x04,0x01,0x02,0x02,0x01,0x02,0x01,0x04 }, BGAV_MK_FOURCC('m', 'p', 'g', 'v'), WRAP_FRAME }, /* D-10 50Mbps PAL */
    { { 0x06,0x0E,0x2B,0x34,0x04,0x01,0x01,0x01,0x04,0x01,0x02,0x02,0x01,0x02,0x01,0x05 }, BGAV_MK_FOURCC('m', 'p', 'g', 'v'), WRAP_FRAME }, /* D-10 50Mbps PAL */
    { { 0x06,0x0E,0x2B,0x34,0x04,0x01,0x01,0x01,0x04,0x01,0x02,0x02,0x01,0x02,0x01,0x06 }, BGAV_MK_FOURCC('m', 'p', 'g', 'v'), WRAP_FRAME }, /* D-10 50Mbps PAL */

    { { 0x06,0x0E,0x2B,0x34,0x04,0x01,0x01,0x03,0x04,0x01,0x02,0x02,0x01,0x03,0x03,0x00 }, BGAV_MK_FOURCC('m', 'p', 'g', 'v') }, /* MP@HL Long GoP */
    { { 0x06,0x0E,0x2B,0x34,0x04,0x01,0x01,0x03,0x04,0x01,0x02,0x02,0x01,0x04,0x02,0x00 }, BGAV_MK_FOURCC('m', 'p', 'g', 'v') }, /* 422P@HL I-Frame */
